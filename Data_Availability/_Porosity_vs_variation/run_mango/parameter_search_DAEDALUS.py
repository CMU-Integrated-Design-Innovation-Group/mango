...
def cell_constraints(input_vars):
    ...
    if bounding_box.a < 30 or bounding_box.a > 120:
        return True
    if bounding_box.b < 30 or bounding_box.b > 120:
        return True
    if bounding_box.c < 30 or bounding_box.c > 120:
        return True
...
def create_box():
    ...
    objective_1 = ObjectiveFunction(name='Porosity', objective_equation=porosity_objective, numDecimals=3,
                                    extra_params={'d': 4.25})  # DAEDALUS ~ 4nm diameter bundles
