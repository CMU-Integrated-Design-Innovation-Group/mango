...
import dill
import random
from mango.utils.design_io import _export_design_to_ply, _export_list_of_designs_to_ply
...
_export_design_to_ply(design=final_design,
...
# Call the export:
_export_list_of_designs_to_ply(design_list=designs_to_export,
